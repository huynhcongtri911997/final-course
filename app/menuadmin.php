...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand my-logo pr-2" href="http://localhost:8080/final-course/app/index.php">Mega Shop</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="http://localhost:8080/final-course/app/index.php">Home</a>
      </ul>
    </div>
  </div>
</nav>